...
<head>
    ...
    <!-- Favicon -->
    {{-- <link rel="icon" type="image/x-icon" href="{{ asset('images/setting/favicon.ico') }}" /> --}}
    <link rel="icon" type="image/x-icon" id="favico" href="" />
    ...
    <script>
        $(window).on('load', function() {
            ...
            fetch(url)
                ...
                .then(data => {
                    $('#favico').attr('href', data.url_favico);
                });
        });
    </script>
@endsection
