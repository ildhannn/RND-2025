...
@section('head')
    <div class="brutal-header">
        <p class="text-light">MANAGEMEN MENU</p>
    </div>
@endsection
                                ...
                                <div class="row justify-content-end mb-4">
                                    <div class="col-md-1">
                                        <a href="{{ route('create-menu') }}"
                                            class="bg-menu-theme btn-brutal-primary d-flex"><i class="mdi mdi-plus"></i>
                                            Tambah</a>
                                    </div>
                                </div>
                                            ...
                                            <ul class="nav nav-pills nav-fill" role="tablist">
                                                <li class="nav-item">
                                                    <button type="button" class="nav-link active" role="tab"
                                                        ...
                                                        Dashboard
                                                        {{-- <span class="brutal-badge rounded-pill brutal-badge-center h-px-20 w-px-20 bg-danger ms-1">3</span> --}}
                                                    </button>
                                                </li>
                                                <li class="nav-item">
                                                                    ...
                                                                    <tr>
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                @foreach ($kewenanganIds as $kewenangan)
                                                                                    <span data-bs-toggle="tooltip"
                                                                                        ...
                                                                                        <i
                                                                                            class="mdi {{ $kewenangan == 1 ? 'mdi-laptop' : ($kewenangan == 2 ? 'mdi-shield-account' : 'mdi-account') }}
                                                                              mdi-20px me-2"></i>
                                                                                    </span>
                                                                                @endforeach
                                                                            </span>
                                                                        ...
                                                                        <td>
                                                                            <a href="/edit_menu/{{ $item->id }}"
                                                                                class="bg-menu-theme btn-brutal-secondary">
                                                                                <i
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                @csrf
                                                                                <button type="submit"
                                                                                    class="bg-menu-theme btn-brutal-danger"
                                                                                    id="hapus_user"><i
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                @foreach ($kewenanganIds as $kewenangan)
                                                                                    <span data-bs-toggle="tooltip"
                                                                                        ...
                                                                                        title="{{ $kewenangan == 1 ? 'Superadmin' : ($kewenangan == 2 ? 'Admin' : 'User') }}">
                                                                                        <i
                                                                                            class="mdi {{ $kewenangan == 1 ? 'mdi-laptop' : ($kewenangan == 2 ? 'mdi-shield-account' : 'mdi-account') }} mdi-20px me-2"></i>
                                                                                    </span>
                                                                                @endforeach
                                                                            </span>
                                                                        </td>
